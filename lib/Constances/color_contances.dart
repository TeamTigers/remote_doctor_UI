...
const kPrimaryColor = const Color(0xFF2979FF);
const kAccentColor = const Color(0xFF212121);
const kBannerBasicColor = const Color(0xFFFFFFFF);

const Color nearlyWhite = Color(0xFFFAFAFA);
const Color white = Color(0xFFFFFFFF);
const Color background = Color(0xFFF2F3F8);
const Color nearlyDarkBlue = Color(0xFF00B6F0);
...
const Color dismissibleBackground = Color(0xFF00B6F0);
